                ...
                <div className="header">
                    <h1 className="logo">
                        ...
                        <svg version="1.1" id="레이어_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 101.9 97">
                            <g id="XMLID_4_">
                                <path id="XMLID_5_" className="st0" d="M58.4,0l-7.5,22.9L43.5,0h-11l12.9,39.7l-1.1,3.4L30.4,0h-11L0,60l8.9,6.4l16.1-49.6l0,0
		l1.1,3.3l0,0L10.6,67.6l8.8,6.4l12-37l0,0l0,0l7.5,23.1h0.1L31.5,83l8.9,6.3L69.3,0L58.4,0L58.4,0z"></path>
                                <polygon id="XMLID_9_" className="st0" points="93,66.4 101.9,60 82.5,0.1 82.5,0 71.5,0 42.3,90.5 51,96.8 50.9,97 51.1,96.9
